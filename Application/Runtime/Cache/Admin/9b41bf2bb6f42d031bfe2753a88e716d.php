...
<html class=" js csstransforms3d"><head>
	...
	<script type="text/javascript" src="/Public/Admin/js/jquery.selectui.js"></script>
	
	<script type="text/javascript" charset="utf-8" src="/Public/Admin/js/utf8-jsp/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/Public/Admin/js/utf8-jsp/ueditor.all.min.js"> </script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="/Public/Admin/js/utf8-jsp/lang/zh-cn/zh-cn.js"></script>
	
	<link rel="stylesheet" type="text/css" href="/Public/Admin/js/webuploader/webuploader.css">    
    <link rel="stylesheet" type="text/css" href="/Public/Admin/js/webuploader/demo.css">
	...
	<![endif]-->
<link href="/Public/Admin/js/utf8-jsp/themes/default/css/ueditor.css" type="text/css" rel="stylesheet">
<script src="/Public/Admin/js/utf8-jsp/third-party/codemirror/codemirror.js" type="text/javascript" defer></script>
<link rel="stylesheet" type="text/css" href="/Public/Admin/js/utf8-jsp/third-party/codemirror/codemirror.css">
<script src="/Public/Admin/js/utf8-jsp/third-party/zeroclipboard/ZeroClipboard.js" type="text/javascript" defer></script></head>
		...
		<div class="superCtab">
			<div class="publishArt">
				...
				<div class="pubMain">
					...
					<form action="<?php echo U('Joke/wenzhang_xinwen_fabu');?>" method="post" enctype='multipart/form-data'>
						...
						<h5 class="pubtitle">发布人</h5>
						<div class="pub-txt-bar">
							<input type="text" class="shuruTxt" name='add_man'>
						</div>
						    ...
						    <div class="queueList">
						        <div id="dndArea" class="placeholder Thumblist">
						            ...
						            <div class="Thumblistbg upload-img">
										<input id="fileImage" type="file" size="30" name="img"/>
