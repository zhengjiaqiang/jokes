...
<body style="background: #f6f5fa;">
	...
	<div class="super-content RightMain" id="RightMain">
		...
		<!--header-->
		<div class="superCtab">
			<div class="ctab-title clearfix"><h3>段子发布</h3><a href="javascript:;" class="sp-column"><i class="ico-mng"></i>栏目管理</a></div>
				...
				<div class="ctab-Mian-cont">
					<div class="Mian-cont-btn clearfix">
						<div class="operateBtn">
							<a href="<?php echo U('Joke/wenzhang_xinwen_fabu');?>" class="greenbtn publish">发布段子</a>
						...
						<div class="searchBar">
							<form action="<?php echo U('Admin/wenzhang_xinwen');?>">
